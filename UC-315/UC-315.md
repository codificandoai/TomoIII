...
> **Integración UC-308:** UC-308 puede envolver un skill/executor ya construido mediante `UC315SkillPredictorAdapter`. Es un contrato inyectable: UC-315 no registra ni auto-conecta predictores a experimentos, y no hay wiring de producción implícito.
