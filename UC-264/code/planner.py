"""Motor de planificación multi-opción para UC-264.

Genera planes candidatos diversos usando estrategias (optimista, conservadora,
balanceada, aleatoria) y una búsqueda tipo MCTS/lookahead ligera.
"""
...
class PlanGenerator:
    ...
    def generate(
        self, request: TravelPlanRequest, num_plans: Optional[int] = None
        ...
        return candidates, {"strategies": strategies, "generated": len(candidates)}
