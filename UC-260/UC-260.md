...
#### USO: . EXTERNO
python UC-260.py plan --origin Madrid --destination Barcelona --departure-date 2026-09-15 --return-date 2026-09-17 --travelers 1 --budget 2000 --currency USD --meeting-time 15:00 --direct-flight --confirm
---
...
![alt text](uc260_bdi_agents_sequence.png)
...
### Planificar un viaje
![alt text](uc260_bdi_operations_flowchart.png)
```bash
