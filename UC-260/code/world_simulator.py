"""Simulación determinista de APIs externas: vuelos, hoteles y eventos (adaptado de UC-259)."""
...
class WorldSimulator:
    """Proveedor externo simulado intercambiable con semilla fija para tests."""
