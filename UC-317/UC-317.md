...
> **Integración UC-308:** `code/paper_execution_service_317.py` es un adaptador mínimo, explícito y exclusivamente paper-only que puede inyectarse en `ChampionChallengerExperiment`. No se auto-descubre, no envía órdenes reales y no representa wiring, transporte o despliegue productivo.
