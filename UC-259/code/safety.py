"""Controles de seguridad para UC-259: prompt injection, PII y acciones irreversibles."""
...
IRREVERSIBLE_ACTIONS = {"book_flight", "book_hotel", "book_car", "confirm_payment"}


class SafetyGuard:
    """Valida entradas de usuario, acciones y datos sensibles."""
